...
export default function ChargeXHero() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-1 ">
          ...
          <div className="order-1 md:order-2 w-full max-w-[613px] mx-auto md:mx-0">
            <div className="relative overflow-visible w-full aspect-[613/420]">
              ...
              <div className="relative border-[3px] border-white rounded-[16px] md:rounded-[24px] overflow-hidden shadow-md bg-transparent w-full h-full z-10">
                <div className="relative w-full h-full">
                  <Image
                    src="/solution/hero/Beige Minimalist Hand Holding Phone Mockup Instagram Post 1.png"
